!function () {
    ...
    function Rt(n, t, e, r) {
        return function (u, i) {
            ...
            var g, p, v, d = t(i), m = u.invert(r[0], r[1]), y = {point: a, lineStart: l, lineEnd: c, polygonStart: function () {
    ...
    function Zt(n, t, e, r) {
        ...
        return function (o) {
            ...
            var v, d, m, y, M, x, b, _, w, S, k, N = o, E = Pt(), A = Yt(n, t, e, r), C = {point: f, lineStart: h, lineEnd: g, polygonStart: function () {
                o = E, v = [], d = [], k = !0
            }, polygonEnd: function () {
                o = N, v = oa.merge(v);
    ...
    function Wt() {
        ...
        var i = Jt(4.5), a = [], o = {point: n, lineStart: function () {
            o.point = t
    ...
    function ee(n) {
        ...
        function r(t) {
            ...
            var f, h, g, p, v, d, m, y, M, x, b, _, w, S = {point: e, lineStart: r, lineEnd: a, polygonStart: function () {
    ...
    function ri(n, t, e, r) {
        ...
        return a.invert = function (t) {
            ...
            var r, o = Math.max(.1, n / a.ticks().length), l = e ? (r = 1e-12, Math.ceil) : (r = -1e-12, Math.floor);
            return function (n) {
    ...
    function ra(n, t, e) {
        ...
        return r.invert = function (t) {
            ...
            return o && (n = o[0], t = o[1]), r.domain(Xu(i, t > 1 ? {floor: function (t) {
            ...
            var e = Yu(r.domain()), i = null == n ? u(e, 10) : "number" == typeof n ? u(e, n) : !n.range && [
                {range: n},
                t
            ];
    ...
    var oa = {version: "3.5.9"}, la = [].slice, ca = function (n) {
        return la.call(n)
    }, sa = this.document;
    if (sa)try {
    ...
    oa.ns = {prefix: Ca, qualify: function (n) {
        var t = n.indexOf(":"), e = n;
    ...
    var so = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i, fo = oa.map({b: function (n) {
        return n.toString(2)
    }, c: function (n) {
    ...
    var Mo = oa.locale({decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""], dateTime: "%a %b %e %X %Y", date: "%m/%d/%Y", time: "%H:%M:%S", periods: ["AM", "PM"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    ...
    oa.format = Mo.numberFormat, oa.geo = {}, st.prototype = {s: 0, t: 0, add: function (n) {
    ...
    oa.geo.clipExtent = function () {
        var n, t, e, r, u, i, a = {stream: function (n) {
        ...
        var t, e, r, u, i = oa.geo.albers(), a = oa.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), o = oa.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {point: function (n, e) {
            t = [n, e]
        }};
    ...
    }, ue.prototype = {point: function (n, t) {
    ...
    var Wo, Jo = {sphere: b, point: b, lineStart: _e, lineEnd: b, polygonStart: b, polygonEnd: b}, Go = we(function (n) {
    ...
    }}, er.prototype = {insert: function (n, t) {
        var e, r, u;
        if (n) {
    ...
    var gl = function () {
        ...
        return Tr
    }}), vl = oa.map({"in": y, out: _r, "in-out": wr, "out-in": function (n) {
        return wr(_r(n))
    }});
    oa.ease = function (n) {
    ...
    oa.interpolateTransform = $r, oa.layout = {}, oa.layout.bundle = function () {
        ...
        return l.tick = function () {
            ...
            return arguments.length ? (n = +n, u ? n > 0 ? u = n : (e.c = null, e.t = NaN, e = null, c.start({type: "end", alpha: u = 0})) : n > 0 && (c.start({type: "start", alpha: u = n}), e = qn(l.tick)), l) : u
        }, l.start = function () {
            function n(n, r) {
                if (!e) {
    ...
    var bl = oa.map({"inside-out": function (n) {
    ...
    }, "default": pu}), _l = oa.map({silhouette: function (n) {
    ...
    var kl = oa.format(".0e"), Nl = {floor: function (n) {
        return-Math.ceil(-n)
    }, ceil: function (n) {
        return-Math.floor(-n)
    }};
    ...
    var Pl = oa.map({circle: $i, cross: function (n) {
    ...
    Aa.transition = function (n) {
        for (var t, e, r = Fl || ++Yl, u = Ki(n), i = [], a = Hl || {time: Date.now(), ease: Nr, delay: 0, duration: 250}, o = -1, l = this.length; ++o < l;) {
            i.push(t = []);
    ...
    var Xl = {n: "ns-resize", e: "ew-resize", s: "ns-resize", w: "ew-resize", nw: "nwse-resize", ne: "nesw-resize", se: "nwse-resize", sw: "nesw-resize"}, $l = [
        ["n", "e", "s", "w", "nw", "ne", "se", "sw"],
        ["e", "w"],
        ["n", "s"],
        []
    ], Bl = ho.format = Mo.timeFormat, Wl = Bl.utc, Jl = Wl("%Y-%m-%dT%H:%M:%S.%LZ");
    ...
    var Gl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], Kl = [
        [ho.second, 1],
        [ho.second, 5],
        [ho.second, 15],
        [ho.second, 30],
